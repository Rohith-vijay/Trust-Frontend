...
const Dashboard = () => {
  ...
  const [settingInputs, setSettingInputs] = useState({
    ...
    HOME_HERO_HIGHLIGHT: "", HOME_HERO_SECONDARY_TEXT: "", HOME_HERO_SECONDARY_LINK: "",
    HOME_HERO_OPACITY: "", HOME_HERO_STATS_LIVES: "", HOME_HERO_STATS_PROJECTS: "",
    HOME_HERO_STATS_EDUCATION: "", HOME_HERO_STATS_VISION: "",
  ...
  const loadSettings = useCallback(async () => {
    try {
      ...
      setSettingInputs(prev => ({
        ...
        HOME_HERO_HIGHLIGHT: s.HOME_HERO_HIGHLIGHT || "",
        HOME_HERO_SECONDARY_TEXT: s.HOME_HERO_SECONDARY_TEXT || "",
        HOME_HERO_SECONDARY_LINK: s.HOME_HERO_SECONDARY_LINK || "",
        HOME_HERO_OPACITY: s.HOME_HERO_OPACITY || "",
        HOME_HERO_STATS_LIVES: s.HOME_HERO_STATS_LIVES || "",
