    ...
    >
      <SiteContainer>
        ...
        <Grid container spacing={3} sx={{ maxWidth: "lg", mx: "auto", px: 3, mb: 12 }}>
          {[
            { icon: <VerifiedUserIcon sx={{ fontSize: 32, color: "#B07A3F" }} />, title: "12A/80G Registration Pending", desc: "The Trust's applicable tax registration/approval is currently under process. No tax benefit or deduction is being promised at this time." },
